...
public class RoadMapInfoDto {
	...
	public RoadMapInfoDto(int roadmap_num, int user_num, String roadmap_title, String roadmap_content,
			int roadmap_subscribe, int roadmap_like, int roadmap_share, int main_num) {
