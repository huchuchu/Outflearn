			...
			<aside class="col-sm-2">
				<div id="side_category">
					<ul class="nav flex-column text-center">
						...
						<li class="nav-item all_category">
							<a href="void:0" id="side_db" class="nav-link active">데이터베이스&nbsp;<i class="fas fa-chevron-right"></i></a>
				...
				<div id="side_checkbox">
					<ul class="nav flex-column text-center" style="clear: both">
						<li class="lg_category nav-item text-left">
							<a href="void:0" id="level_btn" class="nav-link active text-left">난이도&nbsp;<i class="fas fa-chevron-down"></i></a>
							<div id="level" class="collapse">
								<div class="sm_category"><input id="begin" type="checkbox"><label for="begin">초급</label></div>
								<div class="sm_category"><input id="intermediate" type="checkbox"><label for="intermediate">중급</label></div>
								<div class="sm_category"><input id="advanced" type="checkbox"><label for="advanced">고급</label></div>
							</div>
						</li>
						<li class="lg_category nav-item text-left">
							<a href="void:0" id="charged_btn" class="nav-link active">유료/무료&nbsp;<i class="fas fa-chevron-down"></i></a>
							<div id="charged" class="collapse">
								<div class="sm_category"><input id="pay" type="checkbox"><label for="pay">유료</label></div>
								<div class="sm_category"><input id="free" type="checkbox"><label for="free">무료</label></div>
							</div>
						</li>
					</ul>
				</div>
								...
								<c:forEach items="${classinfo }" var="dto">
									<div class="card">
										<a href="LectureDetail?class_num=${dto.class_num }"> <img
											class="card-img-top" src="resources/img/cardpx.svg"
											alt="Card image cap">
											<div class="card-body">
