		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-center">
					<li class="dropdown"><a href="void:0" class="dropdown-toggle" data-toggle="dropdown"
							aria-haspopup="true" aria-expanded="false">분야별
							강좌&nbsp;<i class="fas fa-chevron-down"></i>
							<ul class="dropdown-menu" role="menu">
								<li class="dropdown-submenu"><a class="dropdown-toggle dropright" href="void:0"
										data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">서버&nbsp;<i
								...
								<li><a href="void:0" class="dropdown dropdown-toggle dropdown-item"
