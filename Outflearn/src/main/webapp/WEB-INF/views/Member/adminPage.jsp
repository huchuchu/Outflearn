        ...
        <div class="side_category">
          <ul class="nav flex-column text-center">
            ...
            <li class="nav-item side_menu select">
              <a href="adminPage" class="selectMenu">대시보드</a>
            </li>
                        ...
                        <tbody>
                          <c:forEach items="${userList }" var="item">
                            <tr>
                              ...
                              <td>
                                <c:if test="${item.USER_ENABLED eq '1' }"><button onclick="userEnabled(${item.USER_NUM})" class="updateBtn">Y</button></c:if>
                                <c:if test="${item.USER_ENABLED eq '0' }"><button onclick="userDisabled(${item.USER_NUM})" class="deleteBtn">N</button></c:if>
                              </td>
                            </tr>
                          </c:forEach>
                        </tbody>
