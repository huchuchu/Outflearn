                        ...
                        <tbody>
                          <c:forEach items="${userList }" var="item">
                            <tr>
                              ...
                              <td>
                                <c:if test="${item.USER_ENABLED eq '1' }"><button onclick="userEnabled(${item.USER_NUM})">Y</button></c:if>
                                <c:if test="${item.USER_ENABLED eq '0' }"><button onclick="userDisabled(${item.USER_NUM})">N</button></c:if>
                              </td>
                            </tr>
                          </c:forEach>
                        </tbody>
