         ...
         <div class="col-sm-6 col-md-offset-3">
            ...
            <form method="post" action="${pageContext.request.contextPath}/register.do" onsubmit="return formsubmit();">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="user_id" id="inputName" placeholder="아이디를 입력해 주세요"
                     required />
                  <div id="id_confirm"></div>
                  <div class="form-group text-center">
                     <button type="button" id="btn_idcheck" class="btn btn-info" onclick="id_check()">중복확인<i
               ...
               <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="user_pw" id="inputPassword"
                     placeholder="비밀번호를 입력해 주세요" onchange="pass_check()" required />
                  <div id="pass_check"></div>
                  <input type="password" class="form-control" name="user_pw02" id="inputPassword"
                     placeholder="비밀번호를 확인해 주세요" onchange="pass_confirm()" required />
               ...
               <div class="form-group">
                  ...
                  <div class="form-group text-center">
                     <button type="button" id="user_email" name="btn_emailChk" class="btn btn-info"
                        onclick="email_Chk()">이메일 중복확인<i class="fa fa-check spaceLeft"></i></button>
                  </div>
                  <div class="form-group text-center">
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="ranNum" placeholder="인증번호발송을 먼저 누르시고 인증번호를 입력해주세요"
                     required />
                  <div class="form-group text-center">
                     <input type="button" class="btn btn-info" id="btn_sendemail" value="인증번호발송"
                        onclick="sendEmail()" />
               ...
               <div class="form-group text-center">
                  <button type="submit" id="join-submit" class="btn btn-success">회원가입<i
                        class="fa fa-check spaceLeft"></i></button>
               </div>
