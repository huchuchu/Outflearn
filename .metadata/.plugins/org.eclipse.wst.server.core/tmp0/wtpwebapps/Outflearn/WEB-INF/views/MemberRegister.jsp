...
<link href="resources/css/member.css" type="text/css" rel="stylesheet">
<sec:csrfMetaTags/>
			...
			<form method="post" action="${pageContext.request.contextPath}/register.do" onsubmit="return formsubmit();">
           	<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token }">		
					<div class="form-group">
                        ...
                        <input type="text" class="form-control"  name="user_id" id="inputName" placeholder="아이디를 입력해 주세요" required />
								...
								<div class="form-group text-center" >
									<button type="button" id="btn_idcheck" class="btn btn-member" onclick="id_check()" >중복확인<i class="fa fa-check spaceLeft"></i></button>
									<p class="result"></p>
								</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="form-group text-center">
						<button type="button" id="user_email" name="btn_emailChk" class="btn btn-member" onclick="email_Chk()">이메일 중복확인<i class="fa fa-check spaceLeft"></i></button>
						</div>
						<div class="form-group text-center">
					...
					<div class="form-group">
						<label for="InputEmail">이메일 인증 번호</label>
							...
							<div class="form-group text-center">
							<input type="button" class="btn btn-member" id="btn_sendemail" value="인증번호발송" onclick="sendEmail()"/>
							<input type="button" class="btn btn-member" id="ranChk" value="인증번호확인" onclick="ranNumChk()"/>
							<div id="confirm"></div>
